...
public class ECMMailBackup {
	...
	public void addMailTo(String to) {
		...
		addRecipient(this.mailTo, to);
	//this.mailTo ="tiwari.abhishektiwari748@gamil.com";
		}
...
//	        prop.put("mail.smtp.starttls.enable", "true");
	...
	public static void main(String[] args) throws Exception {
		ECMMailBackup mailObject = new ECMMailBackup();
		mailObject.setUserName("atiwari@eblacorp.com");
		mailObject.setPassword("Ebla@0001");
		mailObject.setEmailFrom("atiwari@eblacorp.com");
		mailObject.setSMTPServer("smtp.office365.com");
		mailObject.addMailTo("apanda@eblacorp.com");
		mailObject.setMessage("hdbfd");
		mailObject.send();
	}
}
