...
export class EcmExcludeUsersComponent implements OnInit {
  ...
  refresh(){
     const subscription = this.us.getExcludedUsers().subscribe(data => this.assignExcludedUsers(data));
...
/*    const searchQueary = {
  ...
  exportToExcel(){
    ...
    this.coreService.exportToExcel( this.ecmExcludeUserList,'ECM_Exclude_Operator.xlsx',array)
  }
}
