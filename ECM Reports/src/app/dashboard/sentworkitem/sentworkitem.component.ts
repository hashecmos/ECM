...
@Component({
    ...
    templateUrl: './sentworkitem.component.html',
    styleUrls : ['./sentworkitem.component.css']
})

export class SentworkitemComponent implements OnInit {
  ...
  exportData() {
    ...
    if (startExport) {
      ...
      if(selectedOption =='pdf'){
        ...
        fileName = 'Sent Workitem' + '.pdf';
      }else if(selectedOption =='excel'){
        mimeType = 'application/vnd.ms-excel';
        fileName = 'Sent Workitem' + '.xlsx';
      }
      this.us.exportReportSentItems(this.reportOrgCode, this.status, this.fromDate, this.toDate, selectedOption).subscribe(res => {
  ...
  activateViewTab() {
    ...
    this.us.getReportSentItems(this.reportOrgCode, this.status, this.fromDate, this.toDate).subscribe(data => this.workItemCount(data));
